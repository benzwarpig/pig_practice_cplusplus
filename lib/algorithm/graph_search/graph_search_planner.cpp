...
static inline std::vector<graph_search::Grid2D> RemoveIslandChain(
    ...
    const std::unordered_set<graph_search::Grid2D, graph_search::HashPoint,
                             graph_search::EqPoint>& input) {
  graph_search::DfsSearchPlanner dfs_planner;

  std::vector<std::vector<graph_search::Grid2D>> chains;
  std::unordered_set<graph_search::Grid2D, graph_search::HashPoint,
                     graph_search::EqPoint>
      input_back;
